...
template <> SQInteger PushClassName<ScriptWaypoint, ScriptType::GS>(HSQUIRRELVM vm) { sq_pushstring(vm, "GSWaypoint"); return 1; }

void SQGSWaypoint_Register(Squirrel &engine)
{
	DefSQClass<ScriptWaypoint, ScriptType::GS> SQGSWaypoint("GSWaypoint");
	...
	SQGSWaypoint.DefSQStaticMethod(engine, &ScriptWaypoint::IsValidWaypoint, "IsValidWaypoint", ".i");
	SQGSWaypoint.DefSQStaticMethod(engine, &ScriptWaypoint::GetWaypointID,   "GetWaypointID",   ".i");
	SQGSWaypoint.DefSQStaticMethod(engine, &ScriptWaypoint::HasWaypointType, "HasWaypointType", ".ii");
