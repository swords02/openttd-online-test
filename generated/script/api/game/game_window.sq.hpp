...
#include "../template/template_window.sq.hpp"


template <> SQInteger PushClassName<ScriptWindow, ScriptType::GS>(HSQUIRRELVM vm) { sq_pushstring(vm, "GSWindow"); return 1; }

void SQGSWindow_Register(Squirrel &engine)
{
	DefSQClass<ScriptWindow, ScriptType::GS> SQGSWindow("GSWindow");
	SQGSWindow.PreRegister(engine, "GSObject");

	SQGSWindow.DefSQConst(engine, ScriptWindow::WN_GAME_OPTIONS_AI,                        "WN_GAME_OPTIONS_AI");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WN_GAME_OPTIONS_GS,                        "WN_GAME_OPTIONS_GS");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WC_SCRIPT_SETTINGS,                        "WC_SCRIPT_SETTINGS");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WC_SCRIPT_LIST,                            "WC_SCRIPT_LIST");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WC_NETWORK_ASK_RELAY,                      "WC_NETWORK_ASK_RELAY");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WC_NETWORK_ASK_SURVEY,                     "WC_NETWORK_ASK_SURVEY");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WC_INDUSTRY_PRODUCTION,                    "WC_INDUSTRY_PRODUCTION");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WC_TOWN_CARGO_GRAPH,                       "WC_TOWN_CARGO_GRAPH");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WC_EXTRA_VIEWPORT,                         "WC_EXTRA_VIEWPORT");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WC_SCRIPT_DEBUG,                           "WC_SCRIPT_DEBUG");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WC_HELPWIN,                                "WC_HELPWIN");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_AIC_DECREASE_NUMBER,                   "WID_AIC_DECREASE_NUMBER");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_AIC_INCREASE_NUMBER,                   "WID_AIC_INCREASE_NUMBER");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_AIC_NUMBER,                            "WID_AIC_NUMBER");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_AIC_DECREASE_INTERVAL,                 "WID_AIC_DECREASE_INTERVAL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_AIC_INCREASE_INTERVAL,                 "WID_AIC_INCREASE_INTERVAL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_AIC_INTERVAL,                          "WID_AIC_INTERVAL");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_AIC_OPEN_URL,                          "WID_AIC_OPEN_URL");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_AP_ACCEPTANCE,                         "WID_AP_ACCEPTANCE");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_RV_RAIL_TYPE_DROPDOWN,                 "WID_RV_RAIL_TYPE_DROPDOWN");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_RV_ROAD_TYPE_DROPDOWN,                 "WID_RV_ROAD_TYPE_DROPDOWN");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BB_BACKGROUND,                         "WID_BB_BACKGROUND");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BEM_CAPTION,                           "WID_BEM_CAPTION");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BEM_MESSAGE,                           "WID_BEM_MESSAGE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BEM_QUIT,                              "WID_BEM_QUIT");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BV_FILTER,                             "WID_BV_FILTER");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BV_CONFIGURE_BADGES,                   "WID_BV_CONFIGURE_BADGES");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BV_BADGE_FILTER,                       "WID_BV_BADGE_FILTER");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_C_NOTE,                                "WID_C_NOTE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_C_PANEL,                               "WID_C_PANEL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_C_SETTINGS,                            "WID_C_SETTINGS");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_C_SELECT_GIVE_MONEY,                   "WID_C_SELECT_GIVE_MONEY");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_C_GIVE_MONEY,                          "WID_C_GIVE_MONEY");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_C_SELECT_HOSTILE_TAKEOVER,             "WID_C_SELECT_HOSTILE_TAKEOVER");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_C_HOSTILE_TAKEOVER,                    "WID_C_HOSTILE_TAKEOVER");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_CF_BALANCE_LINE,                       "WID_CF_BALANCE_LINE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_CF_OWN_VALUE,                          "WID_CF_OWN_VALUE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_CF_INTEREST_RATE,                      "WID_CF_INTEREST_RATE");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCL_SEC_COL_DROP_SEL,                  "WID_SCL_SEC_COL_DROP_SEL");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCMF_SEL_RESIZE,                       "WID_SCMF_SEL_RESIZE");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCMF_STYLE,                            "WID_SCMF_STYLE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCMF_PARTS,                            "WID_SCMF_PARTS");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCMF_PARTS_SCROLLBAR,                  "WID_SCMF_PARTS_SCROLLBAR");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_CI_CAPTION,                            "WID_CI_CAPTION");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_CI_LIST,                               "WID_CI_LIST");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_CI_SCROLLBAR,                          "WID_CI_SCROLLBAR");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BDSW_BACKGROUND,                       "WID_BDSW_BACKGROUND");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BDSW_LT_OFF,                           "WID_BDSW_LT_OFF");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BDSW_LT_ON,                            "WID_BDSW_LT_ON");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BDSW_INFO,                             "WID_BDSW_INFO");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BDSW_ACCEPTANCE,                       "WID_BDSW_ACCEPTANCE");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GSC_BACKGROUND,                        "WID_GSC_BACKGROUND");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GSC_GSLIST,                            "WID_GSC_GSLIST");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GSC_SETTINGS,                          "WID_GSC_SETTINGS");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GSC_SCROLLBAR,                         "WID_GSC_SCROLLBAR");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GSC_CHANGE,                            "WID_GSC_CHANGE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GSC_OPEN_URL,                          "WID_GSC_OPEN_URL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GSC_TEXTFILE,                          "WID_GSC_TEXTFILE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GSC_CONTENT_DOWNLOAD,                  "WID_GSC_CONTENT_DOWNLOAD");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GSC_RESET,                             "WID_GSC_RESET");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GSC_SETTING_DROPDOWN,                  "WID_GSC_SETTING_DROPDOWN");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GL_TOWNNAME_DROPDOWN,                  "WID_GL_TOWNNAME_DROPDOWN");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GL_HEIGHTMAP_HEIGHT_DOWN,              "WID_GL_HEIGHTMAP_HEIGHT_DOWN");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GL_HEIGHTMAP_HEIGHT_TEXT,              "WID_GL_HEIGHTMAP_HEIGHT_TEXT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GL_HEIGHTMAP_HEIGHT_UP,                "WID_GL_HEIGHTMAP_HEIGHT_UP");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GL_SNOW_COVERAGE_DOWN,                 "WID_GL_SNOW_COVERAGE_DOWN");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GL_SNOW_COVERAGE_TEXT,                 "WID_GL_SNOW_COVERAGE_TEXT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GL_SNOW_COVERAGE_UP,                   "WID_GL_SNOW_COVERAGE_UP");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GL_DESERT_COVERAGE_DOWN,               "WID_GL_DESERT_COVERAGE_DOWN");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GL_DESERT_COVERAGE_TEXT,               "WID_GL_DESERT_COVERAGE_TEXT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GL_DESERT_COVERAGE_UP,                 "WID_GL_DESERT_COVERAGE_UP");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GL_BORDERS_PULLDOWN,                   "WID_GL_BORDERS_PULLDOWN");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GL_AI_BUTTON,                          "WID_GL_AI_BUTTON");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GL_GS_BUTTON,                          "WID_GL_GS_BUTTON");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GL_NEWGRF_BUTTON,                      "WID_GL_NEWGRF_BUTTON");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GL_CLIMATE_SEL_LABEL,                  "WID_GL_CLIMATE_SEL_LABEL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GL_CLIMATE_SEL_SELECTOR,               "WID_GL_CLIMATE_SEL_SELECTOR");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GOAL_SELECT_BUTTONS,                   "WID_GOAL_SELECT_BUTTONS");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GOAL_GLOBAL_BUTTON,                    "WID_GOAL_GLOBAL_BUTTON");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GOAL_COMPANY_BUTTON,                   "WID_GOAL_COMPANY_BUTTON");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GRAPH_KEY_BUTTON,                      "WID_GRAPH_KEY_BUTTON");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GRAPH_BACKGROUND,                      "WID_GRAPH_BACKGROUND");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GRAPH_CAPTION,                         "WID_GRAPH_CAPTION");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GRAPH_GRAPH,                           "WID_GRAPH_GRAPH");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GRAPH_RESIZE,                          "WID_GRAPH_RESIZE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GRAPH_HEADER,                          "WID_GRAPH_HEADER");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GRAPH_FOOTER,                          "WID_GRAPH_FOOTER");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GRAPH_ENABLE_CARGOES,                  "WID_GRAPH_ENABLE_CARGOES");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GRAPH_DISABLE_CARGOES,                 "WID_GRAPH_DISABLE_CARGOES");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GRAPH_MATRIX,                          "WID_GRAPH_MATRIX");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GRAPH_MATRIX_SCROLLBAR,                "WID_GRAPH_MATRIX_SCROLLBAR");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GRAPH_RANGE_MATRIX,                    "WID_GRAPH_RANGE_MATRIX");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GRAPH_SCALE_MATRIX,                    "WID_GRAPH_SCALE_MATRIX");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GL_GROUP_BY_ORDER,                     "WID_GL_GROUP_BY_ORDER");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GL_GROUP_BY_DROPDOWN,                  "WID_GL_GROUP_BY_DROPDOWN");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GL_FILTER_BY_CARGO,                    "WID_GL_FILTER_BY_CARGO");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_HW_README,                             "WID_HW_README");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_HW_CHANGELOG,                          "WID_HW_CHANGELOG");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_HW_KNOWN_BUGS,                         "WID_HW_KNOWN_BUGS");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_HW_LICENSE,                            "WID_HW_LICENSE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_HW_FONTS,                              "WID_HW_FONTS");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_HW_WEBSITE,                            "WID_HW_WEBSITE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_HW_WIKI,                               "WID_HW_WIKI");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_HW_BUGTRACKER,                         "WID_HW_BUGTRACKER");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_HW_COMMUNITY,                          "WID_HW_COMMUNITY");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_H_BACKGROUND,                          "WID_H_BACKGROUND");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_DPI_SCENARIO_EDITOR_PANE,              "WID_DPI_SCENARIO_EDITOR_PANE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_DPI_REMOVE_ALL_INDUSTRIES_WIDGET,      "WID_DPI_REMOVE_ALL_INDUSTRIES_WIDGET");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_DPI_CREATE_RANDOM_INDUSTRIES_WIDGET,   "WID_DPI_CREATE_RANDOM_INDUSTRIES_WIDGET");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_IV_GRAPH,                              "WID_IV_GRAPH");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_ID_CAPTION,                            "WID_ID_CAPTION");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_ID_FILTER,                             "WID_ID_FILTER");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_ID_INDUSTRY_LIST,                      "WID_ID_INDUSTRY_LIST");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_ID_HSCROLLBAR,                         "WID_ID_HSCROLLBAR");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_ID_VSCROLLBAR,                         "WID_ID_VSCROLLBAR");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SGI_HELP,                              "WID_SGI_HELP");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_PLT_BACKGROUND,                        "WID_PLT_BACKGROUND");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SLT_CAPTION,                           "WID_SLT_CAPTION");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SLT_BACKGROUND,                        "WID_SLT_BACKGROUND");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_LI_LOCATION,                           "WID_LI_LOCATION");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_QS_DEFAULT_SEL,                        "WID_QS_DEFAULT_SEL");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_QS_MOVE,                               "WID_QS_MOVE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_QS_MOVE_SEL,                           "WID_QS_MOVE_SEL");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_TF_NAVBACK,                            "WID_TF_NAVBACK");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_TF_NAVFORWARD,                         "WID_TF_NAVFORWARD");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_TF_WRAPTEXT,                           "WID_TF_WRAPTEXT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_TF_JUMPLIST,                           "WID_TF_JUMPLIST");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_TF_SEL_JUMPLIST,                       "WID_TF_SEL_JUMPLIST");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NCDS_PROGRESS_BAR,                     "WID_NCDS_PROGRESS_BAR");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NCDS_PROGRESS_TEXT,                    "WID_NCDS_PROGRESS_TEXT");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NG_SEARCH_INTERNET,                    "WID_NG_SEARCH_INTERNET");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NG_SEARCH_LAN,                         "WID_NG_SEARCH_LAN");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_CL_SERVER_SELECTOR,                    "WID_CL_SERVER_SELECTOR");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_CL_SERVER_NAME,                        "WID_CL_SERVER_NAME");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_CL_SERVER_NAME_EDIT,                   "WID_CL_SERVER_NAME_EDIT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_CL_SERVER_VISIBILITY,                  "WID_CL_SERVER_VISIBILITY");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_CL_SERVER_INVITE_CODE,                 "WID_CL_SERVER_INVITE_CODE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_CL_SERVER_CONNECTION_TYPE,             "WID_CL_SERVER_CONNECTION_TYPE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_CL_CLIENT_NAME,                        "WID_CL_CLIENT_NAME");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_CL_CLIENT_NAME_EDIT,                   "WID_CL_CLIENT_NAME_EDIT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_CL_MATRIX,                             "WID_CL_MATRIX");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_CL_SCROLLBAR,                          "WID_CL_SCROLLBAR");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_CL_CLIENT_COMPANY_COUNT,               "WID_CL_CLIENT_COMPANY_COUNT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NJS_PROGRESS_BAR,                      "WID_NJS_PROGRESS_BAR");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NJS_PROGRESS_TEXT,                     "WID_NJS_PROGRESS_TEXT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NJS_CANCELOK,                          "WID_NJS_CANCELOK");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NAR_CAPTION,                           "WID_NAR_CAPTION");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NAR_TEXT,                              "WID_NAR_TEXT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NAR_NO,                                "WID_NAR_NO");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NAR_YES_ONCE,                          "WID_NAR_YES_ONCE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NAR_YES_ALWAYS,                        "WID_NAR_YES_ALWAYS");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NAS_CAPTION,                           "WID_NAS_CAPTION");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NAS_TEXT,                              "WID_NAS_TEXT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NAS_PREVIEW,                           "WID_NAS_PREVIEW");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NAS_LINK,                              "WID_NAS_LINK");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NAS_NO,                                "WID_NAS_NO");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NAS_YES,                               "WID_NAS_YES");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SA_ZOOM,                               "WID_SA_ZOOM");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SA_ZOOM_LAST,                          "WID_SA_ZOOM_LAST");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SA_RESET_REL,                          "WID_SA_RESET_REL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SA_CENTRE,                             "WID_SA_CENTRE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SA_CROSSHAIR,                          "WID_SA_CROSSHAIR");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NP_CAPTION,                            "WID_NP_CAPTION");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NP_SETTING_DROPDOWN,                   "WID_NP_SETTING_DROPDOWN");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_NS_SHOW_EDIT,                          "WID_NS_SHOW_EDIT");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_N_SHOW_GROUP_SEL,                      "WID_N_SHOW_GROUP_SEL");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_O_DEPOT_UNBUNCHING,                    "WID_O_DEPOT_UNBUNCHING");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_O_DEPOT_ACTION,                        "WID_O_DEPOT_ACTION");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_PW_START,                              "WID_PW_START");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_PW_CLASS_SEL,                          "WID_PW_CLASS_SEL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_PW_CLASS_FILTER,                       "WID_PW_CLASS_FILTER");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_PW_CLASS_LIST,                         "WID_PW_CLASS_LIST");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_PW_CLASS_SCROLL,                       "WID_PW_CLASS_SCROLL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_PW_TYPE_SEL,                           "WID_PW_TYPE_SEL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_PW_TYPE_FILTER,                        "WID_PW_TYPE_FILTER");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_PW_MODE_ALL,                           "WID_PW_MODE_ALL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_PW_MODE_USED,                          "WID_PW_MODE_USED");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_PW_MODE_SAVED,                         "WID_PW_MODE_SAVED");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_PW_SHRINK,                             "WID_PW_SHRINK");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_PW_EXPAND,                             "WID_PW_EXPAND");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_PW_TYPE_MATRIX,                        "WID_PW_TYPE_MATRIX");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_PW_TYPE_ITEM,                          "WID_PW_TYPE_ITEM");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_PW_TYPE_SCROLL,                        "WID_PW_TYPE_SCROLL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_PW_TYPE_NAME,                          "WID_PW_TYPE_NAME");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_PW_TYPE_RESIZE,                        "WID_PW_TYPE_RESIZE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_PW_CONFIGURE_BADGES,                   "WID_PW_CONFIGURE_BADGES");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_PW_BADGE_FILTER,                       "WID_PW_BADGE_FILTER");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BS_CAPTION,                            "WID_BS_CAPTION");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BS_BLOCK_SEL,                          "WID_BS_BLOCK_SEL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BS_BLOCK_SPACER_SEL,                   "WID_BS_BLOCK_SPACER_SEL");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BRW_FILTER,                            "WID_BRW_FILTER");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BRW_NAME,                              "WID_BRW_NAME");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_ROT_BUILD_WAYPOINT,                    "WID_ROT_BUILD_WAYPOINT");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BROS_ACCEPTANCE,                       "WID_BROS_ACCEPTANCE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BROS_AVAILABLE_ORIENTATIONS,           "WID_BROS_AVAILABLE_ORIENTATIONS");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRL_CAPTION,                          "WID_SCRL_CAPTION");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRL_LIST,                             "WID_SCRL_LIST");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRL_SCROLLBAR,                        "WID_SCRL_SCROLLBAR");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRL_INFO_BG,                          "WID_SCRL_INFO_BG");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRL_ACCEPT,                           "WID_SCRL_ACCEPT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRS_CAPTION,                          "WID_SCRS_CAPTION");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRS_BACKGROUND,                       "WID_SCRS_BACKGROUND");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRS_SCROLLBAR,                        "WID_SCRS_SCROLLBAR");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRS_RESET,                            "WID_SCRS_RESET");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRS_SETTING_DROPDOWN,                 "WID_SCRS_SETTING_DROPDOWN");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRD_VIEW,                             "WID_SCRD_VIEW");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRD_NAME_TEXT,                        "WID_SCRD_NAME_TEXT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRD_SETTINGS,                         "WID_SCRD_SETTINGS");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRD_SCRIPT_GAME,                      "WID_SCRD_SCRIPT_GAME");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRD_RELOAD_TOGGLE,                    "WID_SCRD_RELOAD_TOGGLE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRD_LOG_PANEL,                        "WID_SCRD_LOG_PANEL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRD_VSCROLLBAR,                       "WID_SCRD_VSCROLLBAR");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRD_COMPANY_BUTTON_START,             "WID_SCRD_COMPANY_BUTTON_START");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRD_COMPANY_BUTTON_END,               "WID_SCRD_COMPANY_BUTTON_END");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRD_BREAK_STRING_WIDGETS,             "WID_SCRD_BREAK_STRING_WIDGETS");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRD_BREAK_STR_ON_OFF_BTN,             "WID_SCRD_BREAK_STR_ON_OFF_BTN");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRD_BREAK_STR_EDIT_BOX,               "WID_SCRD_BREAK_STR_EDIT_BOX");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRD_MATCH_CASE_BTN,                   "WID_SCRD_MATCH_CASE_BTN");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRD_CONTINUE_BTN,                     "WID_SCRD_CONTINUE_BTN");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SCRD_HSCROLLBAR,                       "WID_SCRD_HSCROLLBAR");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_TAB_GENERAL,                        "WID_GO_TAB_GENERAL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_TAB_GRAPHICS,                       "WID_GO_TAB_GRAPHICS");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_TAB_SOUND,                          "WID_GO_TAB_SOUND");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_TAB_SOCIAL,                         "WID_GO_TAB_SOCIAL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_TAB_ADVANCED,                       "WID_GO_TAB_ADVANCED");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_TAB_SELECTION,                      "WID_GO_TAB_SELECTION");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_FULLSCREEN_TEXT,                    "WID_GO_FULLSCREEN_TEXT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_GUI_SCALE,                          "WID_GO_GUI_SCALE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_GUI_SCALE_AUTO,                     "WID_GO_GUI_SCALE_AUTO");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_GUI_SCALE_AUTO_TEXT,                "WID_GO_GUI_SCALE_AUTO_TEXT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_GUI_SCALE_BEVEL_BUTTON,             "WID_GO_GUI_SCALE_BEVEL_BUTTON");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_GUI_SCALE_BEVEL_TEXT,               "WID_GO_GUI_SCALE_BEVEL_TEXT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_GUI_FONT_SPRITE,                    "WID_GO_GUI_FONT_SPRITE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_GUI_FONT_SPRITE_TEXT,               "WID_GO_GUI_FONT_SPRITE_TEXT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_GUI_FONT_AA,                        "WID_GO_GUI_FONT_AA");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_GUI_FONT_AA_TEXT,                   "WID_GO_GUI_FONT_AA_TEXT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_BASE_GRF_DROPDOWN,                  "WID_GO_BASE_GRF_DROPDOWN");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_BASE_GRF_PARAMETERS,                "WID_GO_BASE_GRF_PARAMETERS");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_BASE_GRF_CONTENT_DOWNLOAD,          "WID_GO_BASE_GRF_CONTENT_DOWNLOAD");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_BASE_GRF_OPEN_URL,                  "WID_GO_BASE_GRF_OPEN_URL");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_BASE_SFX_CONTENT_DOWNLOAD,          "WID_GO_BASE_SFX_CONTENT_DOWNLOAD");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_TEXT_SFX_VOLUME,                    "WID_GO_TEXT_SFX_VOLUME");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_BASE_SFX_VOLUME,                    "WID_GO_BASE_SFX_VOLUME");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_BASE_SFX_OPEN_URL,                  "WID_GO_BASE_SFX_OPEN_URL");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_BASE_MUSIC_CONTENT_DOWNLOAD,        "WID_GO_BASE_MUSIC_CONTENT_DOWNLOAD");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_TEXT_MUSIC_VOLUME,                  "WID_GO_TEXT_MUSIC_VOLUME");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_BASE_MUSIC_VOLUME,                  "WID_GO_BASE_MUSIC_VOLUME");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_BASE_MUSIC_JUKEBOX,                 "WID_GO_BASE_MUSIC_JUKEBOX");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_BASE_MUSIC_OPEN_URL,                "WID_GO_BASE_MUSIC_OPEN_URL");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_VIDEO_ACCEL_BUTTON,                 "WID_GO_VIDEO_ACCEL_BUTTON");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_VIDEO_ACCEL_TEXT,                   "WID_GO_VIDEO_ACCEL_TEXT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_VIDEO_VSYNC_BUTTON,                 "WID_GO_VIDEO_VSYNC_BUTTON");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_VIDEO_VSYNC_TEXT,                   "WID_GO_VIDEO_VSYNC_TEXT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_REFRESH_RATE_DROPDOWN,              "WID_GO_REFRESH_RATE_DROPDOWN");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_VIDEO_DRIVER_INFO,                  "WID_GO_VIDEO_DRIVER_INFO");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_SURVEY_SEL,                         "WID_GO_SURVEY_SEL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_SURVEY_PARTICIPATE_BUTTON,          "WID_GO_SURVEY_PARTICIPATE_BUTTON");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_SURVEY_PARTICIPATE_TEXT,            "WID_GO_SURVEY_PARTICIPATE_TEXT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_SURVEY_LINK_BUTTON,                 "WID_GO_SURVEY_LINK_BUTTON");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_SURVEY_PREVIEW_BUTTON,              "WID_GO_SURVEY_PREVIEW_BUTTON");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_SOCIAL_PLUGINS,                     "WID_GO_SOCIAL_PLUGINS");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_SOCIAL_PLUGIN_TITLE,                "WID_GO_SOCIAL_PLUGIN_TITLE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_SOCIAL_PLUGIN_PLATFORM,             "WID_GO_SOCIAL_PLUGIN_PLATFORM");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_SOCIAL_PLUGIN_STATE,                "WID_GO_SOCIAL_PLUGIN_STATE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_FILTER,                             "WID_GO_FILTER");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_OPTIONSPANEL,                       "WID_GO_OPTIONSPANEL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_SCROLLBAR,                          "WID_GO_SCROLLBAR");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_SETTING_PROPERTIES,                 "WID_GO_SETTING_PROPERTIES");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_HELP_TEXT,                          "WID_GO_HELP_TEXT");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_HELP_TEXT_SCROLL,                   "WID_GO_HELP_TEXT_SCROLL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_EXPAND_ALL,                         "WID_GO_EXPAND_ALL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_COLLAPSE_ALL,                       "WID_GO_COLLAPSE_ALL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_RESET_ALL,                          "WID_GO_RESET_ALL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_RESTRICT_CATEGORY,                  "WID_GO_RESTRICT_CATEGORY");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_RESTRICT_TYPE,                      "WID_GO_RESTRICT_TYPE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_RESTRICT_DROPDOWN,                  "WID_GO_RESTRICT_DROPDOWN");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_TYPE_DROPDOWN,                      "WID_GO_TYPE_DROPDOWN");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_GO_SETTING_DROPDOWN,                   "WID_GO_SETTING_DROPDOWN");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_QES_LOCATION,                          "WID_QES_LOCATION");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_QES_MOVE,                              "WID_QES_MOVE");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SM_SHOW_IND_NAMES,                     "WID_SM_SHOW_IND_NAMES");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SM_SHOW_IND_NAMES_SEL,                 "WID_SM_SHOW_IND_NAMES_SEL");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_SV_CLOSE_AIRPORT_SEL,                  "WID_SV_CLOSE_AIRPORT_SEL");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_STL_CARGODROPDOWN,                     "WID_STL_CARGODROPDOWN");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_TD_CAPTION,                            "WID_TD_CAPTION");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_TV_EXPAND_BUILDINGS,                   "WID_TV_EXPAND_BUILDINGS");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_TV_EXPAND_ROADS,                       "WID_TV_EXPAND_ROADS");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_TV_DELETE,                             "WID_TV_DELETE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_TV_GRAPH,                              "WID_TV_GRAPH");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_TF_NEW_TOWN,                           "WID_TF_NEW_TOWN");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_TF_TOWN_ACTION_SEL,                    "WID_TF_TOWN_ACTION_SEL");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_TF_LOAD_FROM_FILE,                     "WID_TF_LOAD_FROM_FILE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_TF_EXPAND_ALL_TOWNS,                   "WID_TF_EXPAND_ALL_TOWNS");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_TF_SIZE_SEL,                           "WID_TF_SIZE_SEL");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_TF_ROAD_LAYOUT_SEL,                    "WID_TF_ROAD_LAYOUT_SEL");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_TF_TOWN_EXPAND_SEL,                    "WID_TF_TOWN_EXPAND_SEL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_TF_EXPAND_BUILDINGS,                   "WID_TF_EXPAND_BUILDINGS");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_TF_EXPAND_ROADS,                       "WID_TF_EXPAND_ROADS");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BH_INFO,                               "WID_BH_INFO");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BH_PROTECT_TOGGLE,                     "WID_BH_PROTECT_TOGGLE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BH_REPLACE_TOGGLE,                     "WID_BH_REPLACE_TOGGLE");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_TT_TEXT,                               "WID_TT_TEXT");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BT_SE_PANE,                            "WID_BT_SE_PANE");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BT_MODE_NORMAL,                        "WID_BT_MODE_NORMAL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BT_MODE_FOREST_SM,                     "WID_BT_MODE_FOREST_SM");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BT_MODE_FOREST_LG,                     "WID_BT_MODE_FOREST_LG");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BT_MANY_RANDOM,                        "WID_BT_MANY_RANDOM");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_BT_TYPE_BUTTON_FIRST,                  "WID_BT_TYPE_BUTTON_FIRST");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_VV_RENAME,                             "WID_VV_RENAME");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_VV_LOCATION,                           "WID_VV_LOCATION");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_VV_ORDER_LOCATION,                     "WID_VV_ORDER_LOCATION");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_VV_FORCE_PROCEED_SEL,                  "WID_VV_FORCE_PROCEED_SEL");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_VV_HONK_HORN,                          "WID_VV_HONK_HORN");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_VL_CAPTION_SHARED_ORDERS,              "WID_VL_CAPTION_SHARED_ORDERS");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_VL_CAPTION_SELECTION,                  "WID_VL_CAPTION_SELECTION");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_VL_ORDER_VIEW,                         "WID_VL_ORDER_VIEW");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_VL_GROUP_ORDER,                        "WID_VL_GROUP_ORDER");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_VL_GROUP_BY_PULLDOWN,                  "WID_VL_GROUP_BY_PULLDOWN");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_VL_FILTER_BY_CARGO,                    "WID_VL_FILTER_BY_CARGO");
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_VL_FILTER_BY_CARGO_SEL,                "WID_VL_FILTER_BY_CARGO_SEL");
	...
	SQGSWindow.DefSQConst(engine, ScriptWindow::WID_W_CATCHMENT,                           "WID_W_CATCHMENT");

	SQGSWindow.DefSQStaticMethod(engine, &ScriptWindow::Close,     "Close",     ".ii");
	SQGSWindow.DefSQStaticMethod(engine, &ScriptWindow::IsOpen,    "IsOpen",    ".ii");
	SQGSWindow.DefSQStaticMethod(engine, &ScriptWindow::Highlight, "Highlight", ".iiii");
