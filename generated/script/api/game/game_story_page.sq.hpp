...
#include "../template/template_story_page.sq.hpp"


template <> SQInteger PushClassName<ScriptStoryPage, ScriptType::GS>(HSQUIRRELVM vm) { sq_pushstring(vm, "GSStoryPage"); return 1; }

void SQGSStoryPage_Register(Squirrel &engine)
{
	DefSQClass<ScriptStoryPage, ScriptType::GS> SQGSStoryPage("GSStoryPage");
	SQGSStoryPage.PreRegister(engine, "GSObject");
	...
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::IsValidStoryPage,             "IsValidStoryPage",             ".i");
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::IsValidStoryPageElement,      "IsValidStoryPageElement",      ".i");
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::IsValidStoryPageElementType,  "IsValidStoryPageElementType",  ".i");
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::New,                          "New",                          ".i.");
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::NewElement,                   "NewElement",                   ".iii.");
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::UpdateElement,                "UpdateElement",                ".ii.");
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::GetPageSortValue,             "GetPageSortValue",             ".i");
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::GetPageElementSortValue,      "GetPageElementSortValue",      ".i");
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::GetCompany,                   "GetCompany",                   ".i");
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::GetDate,                      "GetDate",                      ".i");
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::SetDate,                      "SetDate",                      ".ii");
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::SetTitle,                     "SetTitle",                     ".i.");
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::Show,                         "Show",                         ".i");
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::Remove,                       "Remove",                       ".i");
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::RemoveElement,                "RemoveElement",                ".i");
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::IsValidStoryPageButtonColour, "IsValidStoryPageButtonColour", ".i");
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::IsValidStoryPageButtonFlags,  "IsValidStoryPageButtonFlags",  ".i");
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::IsValidStoryPageButtonCursor, "IsValidStoryPageButtonCursor", ".i");
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::MakePushButtonReference,      "MakePushButtonReference",      ".ii");
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::MakeTileButtonReference,      "MakeTileButtonReference",      ".iii");
	SQGSStoryPage.DefSQStaticMethod(engine, &ScriptStoryPage::MakeVehicleButtonReference,   "MakeVehicleButtonReference",   ".iiii");
